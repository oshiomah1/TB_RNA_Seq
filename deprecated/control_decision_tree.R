...
#ask justin about frst_pst_tb_test_dat 
#removed !is.na (frst_pst_tb_test_date)   4rm case when
...
#check for fallouts
self_report_validated2 = past_tb_table %>%
  mutate(true_diag_b = self_report_validator(prior_tb_self_reported, prior_tb_n_self_reported, frst_pst_tb_test_date)) 
